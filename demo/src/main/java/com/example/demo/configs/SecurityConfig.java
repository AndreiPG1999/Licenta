...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET,"/acces/all/{id}").permitAll()
                .antMatchers(HttpMethod.GET,"/appointment/all/{id}").permitAll()
                .antMatchers(HttpMethod.GET,"/istoric/all/{id}").permitAll()
                ...
                .antMatchers(HttpMethod.GET,"/istoric/find/{email}").permitAll()
                .antMatchers(HttpMethod.GET,"/formular/find/{email}").permitAll()
                ...
                .antMatchers(HttpMethod.PUT,"/formular/updateIdDoctor/{email}/{id}").permitAll()
                .antMatchers(HttpMethod.PUT,"/istoric/updateIdDoctor/{email}/{id}").permitAll()
                .antMatchers(HttpMethod.PUT,"/acces/updateIdDoctor/{email}/{id}").permitAll()
                .antMatchers(HttpMethod.PUT,"/appointment/updateIdDoctor/{email}/{id}").permitAll()
                ...
                .antMatchers(HttpMethod.DELETE, "/istoric/delete/{email}").permitAll()
                ...
                .antMatchers(HttpMethod.DELETE, "/acces/delete/{email}").permitAll()
